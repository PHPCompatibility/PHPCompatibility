...
class NewFunctionsSniffTest extends BaseSniffTest
{
    ...
    public function dataNewFunction()
    {
        return array(
            ...
            array('oci_register_taf_callback', '7.0.20', array(313), '7.2', '5.6'),
            array('oci_unregister_taf_callback', '7.0.20', array(314), '7.2', '5.6'),

            array('curl_multi_errno', '7.0', array(316), '7.1'),
            array('curl_share_errno', '7.0', array(317), '7.1'),
            array('curl_share_strerror', '7.0', array(318), '7.1'),
            array('is_iterable', '7.0', array(319), '7.1'),
            array('pcntl_async_signals', '7.0', array(320), '7.1'),
            array('session_create_id', '7.0', array(321), '7.1'),
            array('session_gc', '7.0', array(322), '7.1'),

            array('ldap_exop', '7.1', array(324), '7.2'),
            array('ldap_exop_passwd', '7.1', array(325), '7.2'),
            array('ldap_exop_whoami', '7.1', array(326), '7.2'),
            array('ldap_parse_exop', '7.1', array(327), '7.2'),
            array('socket_addrinfo_lookup', '7.1', array(328), '7.2'),
            array('socket_addrinfo_connect', '7.1', array(329), '7.2'),
            array('socket_addrinfo_bind', '7.1', array(330), '7.2'),
            array('socket_addrinfo_explain', '7.1', array(331), '7.2'),
            array('stream_isatty', '7.1', array(332), '7.2'),
            array('sapi_windows_vt100_support', '7.1', array(333), '7.2'),
            array('ftp_append', '7.1', array(334), '7.2'),
            array('imagebmp', '7.1', array(335), '7.2'),
            array('imagecreatefrombmp', '7.1', array(336), '7.2'),
            array('imagegetclip', '7.1', array(337), '7.2'),
            array('imageopenpolygon', '7.1', array(338), '7.2'),
            array('imageresolution', '7.1', array(339), '7.2'),
            array('imagesetclip', '7.1', array(340), '7.2'),
            array('hash_hmac_algos', '7.1', array(341), '7.2'),
            array('mb_chr', '7.1', array(342), '7.2'),
            array('mb_ord', '7.1', array(343), '7.2'),
            array('mb_scrub', '7.1', array(344), '7.2'),
        );
    }
