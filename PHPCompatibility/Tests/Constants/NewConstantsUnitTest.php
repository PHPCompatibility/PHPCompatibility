...
final class NewConstantsUnitTest extends BaseSniffTestCase
{
    ...
    public static function dataNewConstant()
    {
        return [
            ...
            ['TCP_USER_TIMEOUT', '8.5', 1748, '8.6'],
            ['AF_UNSPEC', '8.5', 1749, '8.6'],
            ['EAI_BADFLAGS', '8.5', 1750, '8.6'],
            ['EAI_NONAME', '8.5', 1751, '8.6'],
            ['EAI_AGAIN', '8.5', 1752, '8.6'],
            ['EAI_FAIL', '8.5', 1753, '8.6'],
            ['EAI_NODATA', '8.5', 1754, '8.6'],
            ['EAI_FAMILY', '8.5', 1755, '8.6'],
            ['EAI_SOCKTYPE', '8.5', 1756, '8.6'],
            ['EAI_SERVICE', '8.5', 1757, '8.6'],
            ['EAI_ADDRFAMILY', '8.5', 1758, '8.6'],
            ['EAI_SYSTEM', '8.5', 1759, '8.6'],
            ['EAI_OVERFLOW', '8.5', 1760, '8.6'],
            ['EAI_INPROGRESS', '8.5', 1761, '8.6'],
            ['EAI_CANCELED', '8.5', 1762, '8.6'],
            ['EAI_NOTCANCELED', '8.5', 1763, '8.6'],
            ['EAI_ALLDONE', '8.5', 1764, '8.6'],
            ...
            ['STREAM_CRYPTO_STATUS_NONE', '8.5', 1775, '8.6'],
            ['STREAM_CRYPTO_STATUS_WANT_READ', '8.5', 1776, '8.6'],
            ['STREAM_CRYPTO_STATUS_WANT_WRITE', '8.5', 1777, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_BYTES', '8.5', 1778, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_KEYBYTES', '8.5', 1779, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_ND_KEYBYTES', '8.5', 1780, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_ND_TWEAKBYTES', '8.5', 1781, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_ND_INPUTBYTES', '8.5', 1782, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_ND_OUTPUTBYTES', '8.5', 1783, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_NDX_KEYBYTES', '8.5', 1784, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_NDX_TWEAKBYTES', '8.5', 1785, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_NDX_INPUTBYTES', '8.5', 1786, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_NDX_OUTPUTBYTES', '8.5', 1787, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_PFX_KEYBYTES', '8.5', 1788, '8.6'],
            ['SODIUM_CRYPTO_IPCRYPT_PFX_BYTES', '8.5', 1789, '8.6'],
            ['SODIUM_CRYPTO_XOF_SHAKE128_BLOCKBYTES', '8.5', 1790, '8.6'],
            ['SODIUM_CRYPTO_XOF_SHAKE128_STATEBYTES', '8.5', 1791, '8.6'],
            ['SODIUM_CRYPTO_XOF_SHAKE256_BLOCKBYTES', '8.5', 1792, '8.6'],
            ['SODIUM_CRYPTO_XOF_SHAKE256_STATEBYTES', '8.5', 1793, '8.6'],
            ['SODIUM_CRYPTO_XOF_TURBOSHAKE128_BLOCKBYTES', '8.5', 1794, '8.6'],
            ['SODIUM_CRYPTO_XOF_TURBOSHAKE128_STATEBYTES', '8.5', 1795, '8.6'],
            ['SODIUM_CRYPTO_XOF_TURBOSHAKE256_BLOCKBYTES', '8.5', 1796, '8.6'],
            ['SODIUM_CRYPTO_XOF_TURBOSHAKE256_STATEBYTES', '8.5', 1797, '8.6'],
            ['SODIUM_CRYPTO_KEM_PUBLICKEYBYTES', '8.5', 1798, '8.6'],
            ['SODIUM_CRYPTO_KEM_SECRETKEYBYTES', '8.5', 1799, '8.6'],
            ['SODIUM_CRYPTO_KEM_CIPHERTEXTBYTES', '8.5', 1800, '8.6'],
            ['SODIUM_CRYPTO_KEM_SHAREDSECRETBYTES', '8.5', 1801, '8.6'],
            ['SODIUM_CRYPTO_KEM_SEEDBYTES', '8.5', 1802, '8.6'],
            ['SODIUM_CRYPTO_KEM_KEYPAIRBYTES', '8.5', 1803, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_PUBLICKEYBYTES', '8.5', 1804, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_SECRETKEYBYTES', '8.5', 1805, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_CIPHERTEXTBYTES', '8.5', 1806, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_SHAREDSECRETBYTES', '8.5', 1807, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_SEEDBYTES', '8.5', 1808, '8.6'],
            ['SODIUM_CRYPTO_KEM_MLKEM768_KEYPAIRBYTES', '8.5', 1809, '8.6'],
        ];
    }
