...
final class RemovedConstantsUnitTest extends BaseSniffTestCase
{
    ...
    public static function dataDeprecatedConstant()
    {
        return [
            ...
            ['MHASH_ADLER32', '8.5', 838, '8.4'],
            ['MHASH_CRC32', '8.5', 839, '8.4'],
            ['MHASH_CRC32B', '8.5', 840, '8.4'],
            ['MHASH_CRC32C', '8.5', 841, '8.4'],
            ['MHASH_FNV132', '8.5', 842, '8.4'],
            ['MHASH_FNV1A32', '8.5', 843, '8.4'],
            ['MHASH_FNV164', '8.5', 844, '8.4'],
            ['MHASH_FNV1A64', '8.5', 845, '8.4'],
            ['MHASH_GOST', '8.5', 846, '8.4'],
            ['MHASH_HAVAL128', '8.5', 847, '8.4'],
            ['MHASH_HAVAL160', '8.5', 848, '8.4'],
            ['MHASH_HAVAL192', '8.5', 849, '8.4'],
            ['MHASH_HAVAL224', '8.5', 850, '8.4'],
            ['MHASH_HAVAL256', '8.5', 851, '8.4'],
            ['MHASH_JOAAT', '8.5', 852, '8.4'],
            ['MHASH_MD2', '8.5', 853, '8.4'],
            ['MHASH_MD4', '8.5', 854, '8.4'],
            ['MHASH_MD5', '8.5', 855, '8.4'],
            ['MHASH_MURMUR3A', '8.5', 856, '8.4'],
            ['MHASH_MURMUR3C', '8.5', 857, '8.4'],
            ['MHASH_MURMUR3F', '8.5', 858, '8.4'],
            ['MHASH_RIPEMD128', '8.5', 859, '8.4'],
            ['MHASH_RIPEMD160', '8.5', 860, '8.4'],
            ['MHASH_RIPEMD256', '8.5', 861, '8.4'],
            ['MHASH_RIPEMD320', '8.5', 862, '8.4'],
            ['MHASH_SHA1', '8.5', 863, '8.4'],
            ['MHASH_SHA224', '8.5', 864, '8.4'],
            ['MHASH_SHA256', '8.5', 865, '8.4'],
            ['MHASH_SHA384', '8.5', 866, '8.4'],
            ['MHASH_SHA512', '8.5', 867, '8.4'],
            ['MHASH_SNEFRU256', '8.5', 868, '8.4'],
            ['MHASH_TIGER', '8.5', 869, '8.4'],
            ['MHASH_TIGER128', '8.5', 870, '8.4'],
            ['MHASH_TIGER160', '8.5', 871, '8.4'],
            ['MHASH_WHIRLPOOL', '8.5', 872, '8.4'],
            ['MHASH_XXH32', '8.5', 873, '8.4'],
