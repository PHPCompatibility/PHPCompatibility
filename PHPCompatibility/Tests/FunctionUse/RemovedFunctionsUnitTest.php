...
final class RemovedFunctionsUnitTest extends BaseSniffTestCase
{
     ...
     * @return void
     */
    public function testDeprecatedFunction($functionName, $deprecatedIn, $line, $okVersion, $deprecatedVersion = null)
    {
     ...
     * @return void
     */
    public function testDeprecatedFunctionWithAlternative($functionName, $deprecatedIn, $alternative, $line, $okVersion, $deprecatedVersion = null)
    {
        $file = $this->sniffFile(__FILE__, $okVersion);
        $this->assertNoViolation($file, $line);
    ...
    public static function dataDeprecatedFunctionWithAlternative()
    {
        return [
            ...
            ['spl_object_hash', '8.6', 'spl_object_id()', 1430, '8.5'],
        ];
    }
     ...
     * @return void
     */
    public function testRemovedFunction($functionName, $removedIn, $line, $okVersion, $removedVersion = null)
    {
        $file = $this->sniffFile(__FILE__, $okVersion);
        $this->assertNoViolation($file, $line);
    ...
    public static function dataRemovedFunction()
    {
        return [
            ...
            ['imap_8bit', '8.4', 1242, '8.3'],
            ['imap_alerts', '8.4', 1243, '8.3'],
            ['imap_append', '8.4', 1244, '8.3'],
            ['imap_base64', '8.4', 1245, '8.3'],
            ['imap_binary', '8.4', 1246, '8.3'],
            ['imap_body', '8.4', 1247, '8.3'],
            ['imap_bodystruct', '8.4', 1248, '8.3'],
            ['imap_check', '8.4', 1249, '8.3'],
            ['imap_clearflag_full', '8.4', 1250, '8.3'],
            ['imap_close', '8.4', 1251, '8.3'],
            ['imap_create', '8.4', 1252, '8.3'],
            ['imap_createmailbox', '8.4', 1253, '8.3'],
            ['imap_delete', '8.4', 1254, '8.3'],
            ['imap_deletemailbox', '8.4', 1255, '8.3'],
            ['imap_errors', '8.4', 1256, '8.3'],
            ['imap_expunge', '8.4', 1257, '8.3'],
            ['imap_fetch_overview', '8.4', 1258, '8.3'],
            ['imap_fetchbody', '8.4', 1259, '8.3'],
            ['imap_fetchheader', '8.4', 1260, '8.3'],
            ['imap_fetchmime', '8.4', 1261, '8.3'],
            ['imap_fetchstructure', '8.4', 1262, '8.3'],
            ['imap_fetchtext', '8.4', 1263, '8.3'],
            ['imap_gc', '8.4', 1264, '8.3'],
            ['imap_get_quota', '8.4', 1265, '8.3'],
            ['imap_get_quotaroot', '8.4', 1266, '8.3'],
            ['imap_getacl', '8.4', 1267, '8.3'],
            ['imap_getmailboxes', '8.4', 1268, '8.3'],
            ['imap_getsubscribed', '8.4', 1269, '8.3'],
            ['imap_headerinfo', '8.4', 1270, '8.3'],
            ['imap_headers', '8.4', 1271, '8.3'],
            ['imap_is_open', '8.4', 1272, '8.3'],
            ['imap_last_error', '8.4', 1273, '8.3'],
            ['imap_list', '8.4', 1274, '8.3'],
            ['imap_listmailbox', '8.4', 1275, '8.3'],
            ['imap_listscan', '8.4', 1276, '8.3'],
            ['imap_listsubscribed', '8.4', 1277, '8.3'],
            ['imap_lsub', '8.4', 1278, '8.3'],
            ['imap_mail', '8.4', 1279, '8.3'],
            ['imap_mail_compose', '8.4', 1280, '8.3'],
            ['imap_mail_copy', '8.4', 1281, '8.3'],
            ['imap_mail_move', '8.4', 1282, '8.3'],
            ['imap_mailboxmsginfo', '8.4', 1283, '8.3'],
            ['imap_mime_header_decode', '8.4', 1284, '8.3'],
            ['imap_msgno', '8.4', 1285, '8.3'],
            ['imap_mutf7_to_utf8', '8.4', 1286, '8.3'],
            ['imap_num_msg', '8.4', 1287, '8.3'],
            ['imap_num_recent', '8.4', 1288, '8.3'],
            ['imap_open', '8.4', 1289, '8.3'],
            ['imap_ping', '8.4', 1290, '8.3'],
            ['imap_qprint', '8.4', 1291, '8.3'],
            ['imap_rename', '8.4', 1292, '8.3'],
            ['imap_renamemailbox', '8.4', 1293, '8.3'],
            ['imap_reopen', '8.4', 1294, '8.3'],
            ['imap_rfc822_parse_adrlist', '8.4', 1295, '8.3'],
            ['imap_rfc822_parse_headers', '8.4', 1296, '8.3'],
            ['imap_rfc822_write_address', '8.4', 1297, '8.3'],
            ['imap_savebody', '8.4', 1298, '8.3'],
            ['imap_scan', '8.4', 1299, '8.3'],
            ['imap_scanmailbox', '8.4', 1300, '8.3'],
            ['imap_search', '8.4', 1301, '8.3'],
            ['imap_set_quota', '8.4', 1302, '8.3'],
            ['imap_setacl', '8.4', 1303, '8.3'],
            ['imap_setflag_full', '8.4', 1304, '8.3'],
            ['imap_sort', '8.4', 1305, '8.3'],
            ['imap_status', '8.4', 1306, '8.3'],
            ['imap_subscribe', '8.4', 1307, '8.3'],
            ['imap_thread', '8.4', 1308, '8.3'],
            ['imap_timeout', '8.4', 1309, '8.3'],
            ['imap_uid', '8.4', 1310, '8.3'],
            ['imap_undelete', '8.4', 1311, '8.3'],
            ['imap_unsubscribe', '8.4', 1312, '8.3'],
            ['imap_utf7_decode', '8.4', 1313, '8.3'],
            ['imap_utf7_encode', '8.4', 1314, '8.3'],
            ['imap_utf8', '8.4', 1315, '8.3'],
            ['imap_utf8_to_mutf7', '8.4', 1316, '8.3'],
            ['oci_bind_array_by_name', '8.4', 1318, '8.3'],
            ['oci_bind_by_name', '8.4', 1319, '8.3'],
            ['oci_cancel', '8.4', 1320, '8.3'],
            ['oci_client_version', '8.4', 1321, '8.3'],
            ['oci_close', '8.4', 1322, '8.3'],
            ['oci_commit', '8.4', 1323, '8.3'],
            ['oci_connect', '8.4', 1324, '8.3'],
            ['oci_define_by_name', '8.4', 1325, '8.3'],
            ['oci_error', '8.4', 1326, '8.3'],
            ['oci_execute', '8.4', 1327, '8.3'],
            ['oci_fetch', '8.4', 1328, '8.3'],
            ['oci_fetch_all', '8.4', 1329, '8.3'],
            ['oci_fetch_array', '8.4', 1330, '8.3'],
            ['oci_fetch_assoc', '8.4', 1331, '8.3'],
            ['oci_fetch_object', '8.4', 1332, '8.3'],
            ['oci_fetch_row', '8.4', 1333, '8.3'],
            ['oci_field_is_null', '8.4', 1334, '8.3'],
            ['oci_field_name', '8.4', 1335, '8.3'],
            ['oci_field_precision', '8.4', 1336, '8.3'],
            ['oci_field_scale', '8.4', 1337, '8.3'],
            ['oci_field_size', '8.4', 1338, '8.3'],
            ['oci_field_type', '8.4', 1339, '8.3'],
            ['oci_field_type_raw', '8.4', 1340, '8.3'],
            ['oci_free_descriptor', '8.4', 1341, '8.3'],
            ['oci_free_statement', '8.4', 1342, '8.3'],
            ['oci_get_implicit_resultset', '8.4', 1343, '8.3'],
            ['oci_lob_copy', '8.4', 1344, '8.3'],
            ['oci_lob_is_equal', '8.4', 1345, '8.3'],
            ['oci_new_collection', '8.4', 1346, '8.3'],
            ['oci_new_connect', '8.4', 1347, '8.3'],
            ['oci_new_cursor', '8.4', 1348, '8.3'],
            ['oci_new_descriptor', '8.4', 1349, '8.3'],
            ['oci_num_fields', '8.4', 1350, '8.3'],
            ['oci_num_rows', '8.4', 1351, '8.3'],
            ['oci_parse', '8.4', 1352, '8.3'],
            ['oci_password_change', '8.4', 1353, '8.3'],
            ['oci_pconnect', '8.4', 1354, '8.3'],
            ['oci_register_taf_callback', '8.4', 1355, '8.3'],
            ['oci_result', '8.4', 1356, '8.3'],
            ['oci_rollback', '8.4', 1357, '8.3'],
            ['oci_server_version', '8.4', 1358, '8.3'],
            ['oci_set_action', '8.4', 1359, '8.3'],
            ['oci_set_call_timeout', '8.4', 1360, '8.3'],
            ['oci_set_client_identifier', '8.4', 1361, '8.3'],
            ['oci_set_client_info', '8.4', 1362, '8.3'],
            ['oci_set_db_operation', '8.4', 1363, '8.3'],
            ['oci_set_edition', '8.4', 1364, '8.3'],
            ['oci_set_module_name', '8.4', 1365, '8.3'],
            ['oci_set_prefetch', '8.4', 1366, '8.3'],
            ['oci_set_prefetch_lob', '8.4', 1367, '8.3'],
            ['oci_statement_type', '8.4', 1368, '8.3'],
            ['oci_unregister_taf_callback', '8.4', 1369, '8.3'],
            ['pspell_add_to_personal', '8.4', 1371, '8.3'],
            ['pspell_add_to_session', '8.4', 1372, '8.3'],
            ['pspell_check', '8.4', 1373, '8.3'],
            ['pspell_clear_session', '8.4', 1374, '8.3'],
            ['pspell_config_create', '8.4', 1375, '8.3'],
            ['pspell_config_data_dir', '8.4', 1376, '8.3'],
            ['pspell_config_dict_dir', '8.4', 1377, '8.3'],
            ['pspell_config_ignore', '8.4', 1378, '8.3'],
            ['pspell_config_mode', '8.4', 1379, '8.3'],
            ['pspell_config_personal', '8.4', 1380, '8.3'],
            ['pspell_config_repl', '8.4', 1381, '8.3'],
            ['pspell_config_runtogether', '8.4', 1382, '8.3'],
            ['pspell_config_save_repl', '8.4', 1383, '8.3'],
            ['pspell_new', '8.4', 1384, '8.3'],
            ['pspell_new_config', '8.4', 1385, '8.3'],
            ['pspell_new_personal', '8.4', 1386, '8.3'],
            ['pspell_save_wordlist', '8.4', 1387, '8.3'],
            ['pspell_store_replacement', '8.4', 1388, '8.3'],
            ['pspell_suggest', '8.4', 1389, '8.3'],
        ];
    }
     ...
     * @return void
     */
    public function testRemovedFunctionWithAlternative($functionName, $removedIn, $alternative, $line, $okVersion, $removedVersion = null)
    {
        $file = $this->sniffFile(__FILE__, $okVersion);
        $this->assertNoViolation($file, $line);
     ...
     * @return void
     */
    public function testDeprecatedRemovedFunction($functionName, $deprecatedIn, $removedIn, $line, $okVersion, $deprecatedVersion = null, $removedVersion = null)
    {
        $file = $this->sniffFile(__FILE__, $okVersion);
        $this->assertNoViolation($file, $line);
    ...
    public static function dataDeprecatedRemovedFunction()
    {
        return [
            ...
            ['ociinternaldebug', '5.4', '8.0', 69, '5.3'],
            ...
            ['ocifetchinto', '5.4', '8.4', 63, '5.3'],
            ['ocibindbyname', '5.4', '8.4', 41, '5.3'],
            ['ocicancel', '5.4', '8.4', 42, '5.3'],
            ['ocicloselob', '5.4', '8.4', 43, '5.3'],
            ['ocicollappend', '5.4', '8.4', 44, '5.3'],
            ['ocicollassign', '5.4', '8.4', 45, '5.3'],
            ['ocicollassignelem', '5.4', '8.4', 46, '5.3'],
            ['ocicollgetelem', '5.4', '8.4', 47, '5.3'],
            ['ocicollmax', '5.4', '8.4', 48, '5.3'],
            ['ocicollsize', '5.4', '8.4', 49, '5.3'],
            ['ocicolltrim', '5.4', '8.4', 50, '5.3'],
            ['ocicolumnisnull', '5.4', '8.4', 51, '5.3'],
            ['ocicolumnname', '5.4', '8.4', 52, '5.3'],
            ['ocicolumnprecision', '5.4', '8.4', 53, '5.3'],
            ['ocicolumnscale', '5.4', '8.4', 54, '5.3'],
            ['ocicolumnsize', '5.4', '8.4', 55, '5.3'],
            ['ocicolumntype', '5.4', '8.4', 56, '5.3'],
            ['ocicolumntyperaw', '5.4', '8.4', 57, '5.3'],
            ['ocicommit', '5.4', '8.4', 58, '5.3'],
            ['ocidefinebyname', '5.4', '8.4', 59, '5.3'],
            ['ocierror', '5.4', '8.4', 60, '5.3'],
            ['ociexecute', '5.4', '8.4', 61, '5.3'],
            ['ocifetch', '5.4', '8.4', 62, '5.3'],
            ['ocifetchstatement', '5.4', '8.4', 64, '5.3'],
            ['ocifreecollection', '5.4', '8.4', 65, '5.3'],
            ['ocifreecursor', '5.4', '8.4', 66, '5.3'],
            ['ocifreedesc', '5.4', '8.4', 67, '5.3'],
            ['ocifreestatement', '5.4', '8.4', 68, '5.3'],
            ['ociloadlob', '5.4', '8.4', 70, '5.3'],
            ['ocilogoff', '5.4', '8.4', 71, '5.3'],
            ['ocilogon', '5.4', '8.4', 72, '5.3'],
            ['ocinewcollection', '5.4', '8.4', 73, '5.3'],
            ['ocinewcursor', '5.4', '8.4', 74, '5.3'],
            ['ocinewdescriptor', '5.4', '8.4', 75, '5.3'],
            ['ocinlogon', '5.4', '8.4', 76, '5.3'],
            ['ocinumcols', '5.4', '8.4', 77, '5.3'],
            ['ociparse', '5.4', '8.4', 78, '5.3'],
            ['ociplogon', '5.4', '8.4', 79, '5.3'],
            ['ociresult', '5.4', '8.4', 80, '5.3'],
            ['ocirollback', '5.4', '8.4', 81, '5.3'],
            ['ocirowcount', '5.4', '8.4', 82, '5.3'],
            ['ocisavelob', '5.4', '8.4', 83, '5.3'],
            ['ocisavelobfile', '5.4', '8.4', 84, '5.3'],
            ['ociserverversion', '5.4', '8.4', 85, '5.3'],
            ['ocisetprefetch', '5.4', '8.4', 86, '5.3'],
            ['ocistatementtype', '5.4', '8.4', 87, '5.3'],
            ['ociwritelobtofile', '5.4', '8.4', 88, '5.3'],
            ['ociwritetemporarylob', '5.4', '8.4', 89, '5.3'],
        ];
    }
     ...
     * @return void
     */
    public function testDeprecatedRemovedFunctionWithAlternative($functionName, $deprecatedIn, $removedIn, $alternative, $line, $okVersion, $deprecatedVersion = null, $removedVersion = null)
    {
        $file = $this->sniffFile(__FILE__, $okVersion);
        $this->assertNoViolation($file, $line);
