...
final class NewFunctionsUnitTest extends BaseSniffTestCase
{
    ...
    public static function dataNewFunction()
    {
        return [
            ...
            ['sodium_crypto_ipcrypt_keygen', '8.5', 1124, '8.6'],
            ['sodium_crypto_ipcrypt_encrypt', '8.5', 1125, '8.6'],
            ['sodium_crypto_ipcrypt_decrypt', '8.5', 1126, '8.6'],
            ['sodium_crypto_ipcrypt_nd_keygen', '8.5', 1127, '8.6'],
            ['sodium_crypto_ipcrypt_nd_encrypt', '8.5', 1128, '8.6'],
            ['sodium_crypto_ipcrypt_nd_decrypt', '8.5', 1129, '8.6'],
            ['sodium_crypto_ipcrypt_ndx_keygen', '8.5', 1130, '8.6'],
            ['sodium_crypto_ipcrypt_ndx_encrypt', '8.5', 1131, '8.6'],
            ['sodium_crypto_ipcrypt_ndx_decrypt', '8.5', 1132, '8.6'],
            ['sodium_crypto_ipcrypt_pfx_keygen', '8.5', 1133, '8.6'],
            ['sodium_crypto_ipcrypt_pfx_encrypt', '8.5', 1134, '8.6'],
            ['sodium_crypto_ipcrypt_pfx_decrypt', '8.5', 1135, '8.6'],
            ['sodium_bin2ip', '8.5', 1136, '8.6'],
            ['sodium_ip2bin', '8.5', 1137, '8.6'],
            ['sodium_crypto_xof_shake128', '8.5', 1138, '8.6'],
            ['sodium_crypto_xof_shake128_init', '8.5', 1139, '8.6'],
            ['sodium_crypto_xof_shake128_update', '8.5', 1140, '8.6'],
            ['sodium_crypto_xof_shake128_squeeze', '8.5', 1141, '8.6'],
            ['sodium_crypto_xof_shake256', '8.5', 1142, '8.6'],
            ['sodium_crypto_xof_shake256_init', '8.5', 1143, '8.6'],
            ['sodium_crypto_xof_shake256_update', '8.5', 1144, '8.6'],
            ['sodium_crypto_xof_shake256_squeeze', '8.5', 1145, '8.6'],
            ['sodium_crypto_xof_turboshake128', '8.5', 1146, '8.6'],
            ['sodium_crypto_xof_turboshake128_init', '8.5', 1147, '8.6'],
            ['sodium_crypto_xof_turboshake128_update', '8.5', 1148, '8.6'],
            ['sodium_crypto_xof_turboshake128_squeeze', '8.5', 1149, '8.6'],
            ['sodium_crypto_xof_turboshake256', '8.5', 1150, '8.6'],
