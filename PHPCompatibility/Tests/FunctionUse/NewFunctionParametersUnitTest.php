...
final class NewFunctionParametersUnitTest extends BaseSniffTestCase
{
    ...
    public static function dataInvalidParameter()
    {
        return [
            ...
            ['grapheme_strpos', 'locale', '8.4', [162], '8.5'],
            ['grapheme_stripos', 'locale', '8.4', [163], '8.5'],
            ['grapheme_strrpos', 'locale', '8.4', [164], '8.5'],
            ['grapheme_strripos', 'locale', '8.4', [165], '8.5'],
            ['grapheme_substr', 'locale', '8.4', [166], '8.5'],
            ['grapheme_strstr', 'locale', '8.4', [167], '8.5'],
            ['grapheme_stristr', 'locale', '8.4', [168], '8.5'],
            ...
            ['openssl_sign', 'padding', '8.4', [173], '8.6'], // OK version > version in which last parameter was added to the function.
            ['openssl_sign', 'salt_length', '8.5', [173], '8.6'],
            ['openssl_verify', 'algorithm', '5.1', [63], '5.2'],
            ['openssl_verify', 'padding', '8.4', [174], '8.6'], // OK version > version in which last parameter was added to the function.
            ['openssl_verify', 'salt_length', '8.5', [174], '8.6'],
            ...
            ['stream_copy_to_stream', 'context', '8.5', [182], '8.6'],
            ['stream_get_contents', 'offset', '5.0', [83], '5.1'],
            ['stream_is_local', 'context', '8.5', [184], '8.6'],
            ['stream_select', 'context', '8.5', [180, 181], '8.6'],
            ['stream_socket_pair', 'context', '8.5', [183], '8.6'],
