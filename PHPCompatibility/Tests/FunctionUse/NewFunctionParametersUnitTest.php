...
class NewFunctionParametersUnitTest extends BaseSniffTest
{
    ...
    {
        return [
            ['array_filter', 'flag', '5.5', [11], '5.6'],
            ['array_slice', 'preserve_keys', '5.0.1', [12], '5.1', '5.0'],
            ['array_unique', 'sort_flags', '5.2.8', [13], '5.3', '5.2'],
            ...
            ['curl_multi_info_read', 'msgs_in_queue', '5.1', [20], '5.2'],
            ['date_time_set', 'microseconds', '7.0', [119], '7.1'],
            ...
            ['http_build_query', 'enc_type', '5.3', [37], '5.4'],
            ...
            ['imap_open', 'n_retries', '5.1', [43], '5.4'],
            ['imap_open', 'params', '5.3.1', [43], '5.4', '5.3'],
            ['imap_reopen', 'n_retries', '5.1', [44], '5.2'],
            ['ini_get_all', 'details', '5.2', [45], '5.3'],
            ['is_a', 'allow_string', '5.3.8', [46], '5.4', '5.3'],
            ['is_subclass_of', 'allow_string', '5.3.8', [47], '5.4', '5.3'],
            ['iterator_to_array', 'use_keys', '5.2.0', [48], '5.3', '5.2'], // Function introduced in 5.2.1.
            ['json_decode', 'depth', '5.2', [49], '5.4'], // OK version > version in which last parameter was added to the function.
            ['json_decode', 'options', '5.3', [49], '5.4'],
            ['json_encode', 'options', '5.2', [50], '5.5'], // OK version > version in which last parameter was added to the function.
            ['json_encode', 'depth', '5.4', [50], '5.5'],
            ['ldap_add', 'serverctrls', '7.2', [106], '7.3'],
            ['ldap_compare', 'serverctrls', '7.2', [107], '7.3'],
            ['ldap_delete', 'serverctrls', '7.2', [108], '7.3'],
            ['ldap_exop', 'serverctrls', '7.2', [121], '7.3'],
            ['ldap_exop_passwd', 'serverctrls', '7.2', [122], '7.3'],
            ['ldap_list', 'serverctrls', '7.2', [109], '7.3'],
            ['ldap_mod_add', 'serverctrls', '7.2', [110], '7.3'],
            ['ldap_mod_del', 'serverctrls', '7.2', [111], '7.3'],
            ['ldap_mod_replace', 'serverctrls', '7.2', [112], '7.3'],
            ['ldap_modify_batch', 'serverctrls', '7.2', [113], '7.3'],
            ['ldap_parse_result', 'serverctrls', '7.2', [114], '7.3'],
            ['ldap_read', 'serverctrls', '7.2', [115], '7.3'],
            ['ldap_rename', 'serverctrls', '7.2', [116], '7.3'],
            ['ldap_search', 'serverctrls', '7.2', [117], '7.3'],
            ...
            ['mb_encode_numericentity', 'is_hex', '5.3', [53], '5.4'],
            ['mb_strrpos', 'offset', '5.1', [54], '5.2'],
            ...
            ['openssl_open', 'method', '5.2', [103], '7.0'], // OK version > version in which last parameter was added to the function.
            ...
            ['openssl_pkcs7_verify', 'p7bfilename', '7.1', [61], '7.2'],
            ['openssl_seal', 'method', '5.2', [62], '7.0'], // OK version > version in which last parameter was added to the function.
            ['openssl_seal', 'iv', '5.6', [62], '7.0'],
            ['openssl_verify', 'signature_alg', '5.1', [63], '5.2'],
            ...
            ['pg_fetch_all', 'result_type', '7.0', [99], '7.1'],
            ['pg_last_notice', 'option', '7.0', [100], '7.1'],
            ['pg_lo_create', 'object_id', '5.2', [66], '5.3'],
            ['pg_lo_import', 'object_id', '5.2', [67], '5.3'],
            ['pg_meta_data', 'extended', '5.5', [125], '5.6'],
            ['pg_select', 'result_type', '7.0', [101], '7.1'],
            ...
            ['sem_acquire', 'nowait', '5.6.0', [71], '7.0', '5.6'],
            ...
            ['str_word_count', 'charlist', '5.0', [87], '5.1'],
            ['substr_count', 'offset', '5.0', [88], '5.1'],
            ['substr_count', 'length', '5.0', [88], '5.1'],
            ['sybase_connect', 'new', '5.2', [89], '5.3'],
            ['timezone_transitions_get', 'timestamp_begin', '5.2', [90], '5.3'],
            ['timezone_transitions_get', 'timestamp_end', '5.2', [90], '5.3'],
            ['timezone_identifiers_list', 'what', '5.2', [91], '5.3'],
            ['timezone_identifiers_list', 'country', '5.2', [91], '5.3'],
            ['token_get_all', 'flags', '5.6', [92], '7.0'],
            ['ucwords', 'delimiters', '5.4.31', [93], '5.6', '5.4'], // Function introduced in 5.4.31 and 5.5.15.
