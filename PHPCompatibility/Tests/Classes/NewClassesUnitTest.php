...
class NewClassesUnitTest extends BaseSniffTest
{
    ...
    public function dataNewClass()
    {
        return array(
            ...
            array('DOMException', '5.0.2', array(232, 260), '5.1', '5.0'),
            array('mysqli_sql_exception', '5.0.2', array(202, 233), '5.1', '5.0'),
            array('ReflectionException', '5.0.2', array(187, 235), '5.1', '5.0'),
            array('SoapFault', '5.0.2', array(236), '5.1', '5.0'),
            array('SQLiteException', '5.0.2', array(340), '5.1', '5.0'),
            ...
            array('IntlException', '5.5', array(239), '5.6'),
